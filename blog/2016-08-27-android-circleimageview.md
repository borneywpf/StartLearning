...
可以显示图片中的一部分    ![android_circleimageview_1](/images/android_circleimageview_1.png)<br>
![android_circleimageview_2](/images/android_circleimageview_2.png)    可以使用Xfermode和BitmapShaper的方式渲染<br>
可以设置生成圆角图片    ![android_circleimageview_3](/images/android_circleimageview_3.png)
