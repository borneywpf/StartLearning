...
<!--more-->
先看效果图！！！<br>
![circlerotaprogressbar](/images/circlerotaprogressbar.gif)
...
## 重新的封装
这几天回顾了下自己实现的这个控件，虽然当时实现的有些复杂，但我还蛮喜欢这个控件的效果；于是乎就查询了些资料，重新封装，顺便温习下一些知识点，也希望能对读者有用.<br><br>
下面我会逐步分析重新实现控件的内容
